...
#
# Script generated by Vivado on Mon Jul 22 11:08:24 -0700 2024
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_clk_div_scale_auto.gen/sources_1/bd/clk_div/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../project_clk_div_scale_auto.gen/sources_1/bd/clk_div/ipshared/aed8/hdl" +incdir+"../../../../project_clk_div_scale_auto.gen/sources_1/bd/clk_div/ipshared/ec67/hdl" +incdir+"../../../../project_clk_div_scale_auto.gen/sources_1/bd/clk_div/ipshared/aed8/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_div xil_defaultlib.glbl -o clk_div_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_div_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_div_simv.daidir vcs_lib c.obj)
